...
// TOKENS CONFIRMADOS via pools.json + suprascan.io
// Todos os FA tokens têm decimals=8 (confirmado via pool_balances empiricamente)
// Excepção: BLWK tem decimals=6
...
const FALLBACK = {
  ...
  // FA tokens — endereço nu (confirmados via suprascan + pools.json)
  '0x4b28b64c9fa2e5a10f8fb57f1df741f40f58d1eafcfb6ae7c6cfbc68c83d32f7': { symbol: 'iSUPRA',   decimals: 8 },
  '0xbb3c1ca1ef67b1a994f2463978695c7bf890710182f75edef05ad08490be3658':  { symbol: 'iUSDC',    decimals: 8 },
  ...
  '0x90a8e901e02ac1539af4a865bbe4a6b96edc27375488803cfbbd6875ec57b281':  { symbol: 'iUSDT',    decimals: 8 },
  ...
  '0x3bccf225c4f1ea4c8e90a0fee5e49ea7ef4f05d6a82d76fbdb8782d3f82f225':   { symbol: 'TCP',      decimals: 8 },
  '0x1118bb79c6a4d8e79c63e9ccab7e92e5e5c88b507dabb40fcadcde67ab7b0052':  { symbol: 'HERO',     decimals: 8 },
  '0x2e8512e4a6e47b1ab9bbcef054e5d130b843e70c8179b3eab6c56c393c4117':    { symbol: 'BEYOND8',  decimals: 8 },
  '0x927e5c99c4b4ef5a15cb5376e96a25ece2745d03e3d12897ee765fa77e2af4e':    { symbol: 'ARTC',     decimals: 8 },
  '0x24deb5afeb93ff140fac344ceaee448fb6f5277a464f6c520dd7788e3e9337':     { symbol: 'SVLT',     decimals: 8 },
  '0x7076c68b9a7f4c43ef4c7b1d1af7f69f4f3b7e2b2c4a4b7e2b2c4a4b7026bb':   { symbol: 'SOLID',    decimals: 8 },
};

// Carregar token_metadata.json gerado por resolveTokens.js (se existir)
let _dynamic = {};
try {
  const metaPath = path.join(__dirname, '../../data/token_metadata.json');
...
function getDecimals(addr) { return FA_MAP[addr]?.decimals ?? 8; }
function getInfo(addr)     { return FA_MAP[addr] || { symbol: getSymbol(addr), decimals: 8 }; }
function isKnown(addr)     { return !!(FA_MAP[addr]?.symbol); }
function allTokens()       { return FA_MAP; }

module.exports = { FA_MAP, getSymbol, getDecimals, getInfo, isKnown, allTokens };
